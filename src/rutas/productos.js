...
const {CategoriasTodas,pedirproducto ,informacionAdicional,categoriasindividual,categorias,informacionmostrarcategoria,VideosTodos,SubirUrl} = require('../controllers/productos');
